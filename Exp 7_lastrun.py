...
expName = 'Exp 7'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Dell 3148\\Desktop\\Data 7\\Exp 7_lastrun.py',
...
polygon_2 = visual.ShapeStim(
    ...
    size=(0.2, 0.2), vertices='circle',
    ori=0.0, pos=(0, 0), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor=[-0.2549, 0.2392, 0.2549], fillColor=[-0.2549, 0.2392, 0.2549],
...
text = visual.TextStim(win=win, name='text',
    text='Report the dellay between the key press and the beep sound (0-999). Click submit after entering the value.',
    font='Open Sans',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/Dell 3148/Desktop/Data 7/New Microsoft Excel Worksheet.xlsx'),
